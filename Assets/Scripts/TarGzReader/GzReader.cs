...
{
    public static class GzReader
    {
        /// <summary>
        /// Extracts the <i>.gz</i> archive into a memory stream.
        /// </summary>
        /// <param name="filename">The <i>.tar.gz</i> to decompress and extract.</param>
        public static MemoryStream ExtractGz(string filename)
        {
            using (var stream = File.OpenRead(filename))
            {
                return ExtractGz(stream);
            }
        }
        ...
        public static MemoryStream ExtractGz(Stream stream)
        {
